...
### 👩 Анна, 32 года - Молодая мама из Мытищ
**Профиль:** Работающая мама с маленьким ребенком, живет в Мытищах, ценит время и удобство
**Устройства:** Смартфон (80%), планшет (20%)
**Болевые точки:** Нехватка времени, нужны быстрые решения, важна близость к дому

**Цели:**
- Найти клинику рядом с домом в Мытищах
...
journey
    ...
    section Поиск информации
      Ищет "клиника Мытищи" в Google: 3: Пациент
      Видит локацию на первом экране: 5: Пациент
...
### 📍 Локальный поиск
Поиск "клиника Мытищи", "реабилитация рядом со мной"

---

## 🗺️ Геолокация и локальный контекст

### Важность указания локации

**Критическая проблема:** Пользователи из Москвы не поедут в Мытищи с другого конца города.

**Решение:** Локация "Мытищи" должна быть видна на первом экране (hero section) всех страниц.

### Целевая аудитория по географии

**Основная аудитория:**
- 🎯 Жители Мытищ (70%)
- 🎯 Жители ближайших районов: Королёв, Пушкино, Щёлково (20%)
- 🎯 Северо-восточные районы Москвы: СВАО (10%)

**Не целевая аудитория:**
- ❌ Жители центра и юга Москвы (слишком далеко)
...
- "реабилитация Мытищи"
- "физиотерапия Мытищи"
- "клиника рядом со мной" (с геолокацией)

**Обязательные элементы:**
- 📍 Emoji-иконка локации в hero section
- "в Мытищах" в заголовке H1
- Адрес в футере на каждой странице
- Карта с геометкой
- Schema.org разметка с координатами Мытищ
...
graph TD
    ...
    Search -->|Информация о клинике| Info[Изучает разделы О нас, Услуги]
