...
1.  **Создание типа записей "Услуги":**
    ...
    *   Нажмите **Add/Edit Post Types**.
    *   Для `Post Type Slug` введите `service`.
    *   Для `Plural Label` введите `Услуги`.
    *   Для `Singular Label` введите `Услуга`.
    *   Прокрутите вниз до **Settings**. Найдите `Has Archive` и установите значение `True`.
    *   Нажмите **Add Post Type**. Вы должны увидеть новое меню "Услуги" в боковой панели!
...
3.  **Добавление кастомных полей к "Услугам":**
    *   Перейдите в новое меню **Custom Fields**.
    *   Нажмите **Add New**, чтобы создать группу полей. Назовите ее `Поля услуги`.
    *   В разделе **Location** установите правило `Показывать эту группу полей, если Тип записи равен Услуга`.
    *   Теперь добавляйте поля, нажимая **+ Add Field**. Согласно архитектурному документу, создайте поля для:
...
4.  **Добавление кастомных полей к "Врачам":**
    ...
    *   Установите правило **Location** на `Тип записи равен Врач`.
    *   Добавьте поля для:
...
## Фаза 5: Финальная настройка и предстартовые проверки
